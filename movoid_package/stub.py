...
class Stub:
    ...
    def init(self):
        ...
        for key, item in module.__dict__.items():
            ...
            if not key.startswith('__'):
                ...
                if item_module is None:
                    self_module = True
                elif hasattr(item_module, '__file__'):
                    self_module = item_module.__file__ == self._module.__file__
                if self_module:
        ...
        for name, package in self._imports.items():
            if hasattr(package, '__file__') and package.__file__ == self._module.__file__:
                continue
